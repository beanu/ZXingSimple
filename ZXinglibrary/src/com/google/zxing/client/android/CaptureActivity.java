...
import com.google.zxing.client.util.PreferenceConfig;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	private void handleDecodeInternally(Result rawResult, URIResultHandler resultHandler, Bitmap barcode) {
		...
		Log.d(TAG, String.format("formatText=%s typeText=%s timeText=%s displayContents=%s", format, type,
				formattedTime, displayContents));
	...
	private void displayFrameworkBugMessageAndExit() {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle(getString(R.string.zx_app_name));
